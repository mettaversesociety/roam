class Game {
    ...
    init() {
        ...
        this.scene.fog = new THREE.Fog(0xa0a0a0, 1000, 5000); // fog gradient starts at 200 and is fully set at 1000
    ...
    loadEnvironment(loader) {
        const game = this;
        loader.load(`${this.assetsPath}fbx/ProxyTest.fbx`, function (object) {
